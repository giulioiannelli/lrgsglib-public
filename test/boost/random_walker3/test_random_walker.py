...
def run_multiple_realizations(width, height, pflip, navg, navg2, coordination_number):
    ...
    return step_distances, euclidean_distances, stopped_nodes
...
if __name__ == "__main__":
    ...
    step_distances, euclidean_distances, stopped_nodes = run_multiple_realizations(
        args.width, args.height, args.pflip, args.navg, args.navg2, args.coordination_number)
    
    print("Statistics Step Distance:", np.mean(step_distances), np.std(step_distances))
    print("Statistics Euclidean Distance:",  np.mean(euclidean_distances), np.std(euclidean_distances))

...
for avg in range(args.number_of_averages):
    ...
    try:
        filenameold = f'{lattice.lrgsgpath}p={args.p:.3g}_na={avg}_{args.out_suffix}.pickle'
        os.remove(filenameold)
    except OSError:
        pass
    filename = f'{lattice.lrgsgpath}p={args.p:.3g}_na={avg+1}_{args.out_suffix}.pickle'
